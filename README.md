...
This project began as a simple CRUD budgeting API to demo clean architecture principals. While functional, that approach broke down once corrections, historical accuracy, and explainability of transactions were considered.
